...
if select== "Home":
  ...
  st.write("***Welcome to BizCardX – Effortless Business Card Data Extraction***")

  st.write("Transform your business networking experience with BizCardX, the ultimate tool for extracting, managing, and organizing information from business cards in seconds. Powered by Optical Character Recognition (OCR) technology and a user-friendly Streamlit interface, BizCardX streamlines data extraction and storage, so you can focus on building connections.")

  st.image("/content/maxresdefault.jpg")
  st.write("### Key Features:")
  st.write("- **OCR-Powered Data Extraction**: Instantly capture and convert business card information, such as names, phone numbers, and emails, into editable digital formats.")
  st.write("- **Intuitive Streamlit GUI**: Enjoy a seamless, accessible interface that simplifies the data extraction process for users at all skill levels.")
  st.write("- **Secure SQL Database Storage**: Safely store, organize, and retrieve all extracted data, ensuring that you always have your contacts at your fingertips.")
  st.write("- **Efficient Workflow Management**: Edit, delete, and manage extracted information effortlessly, so your contacts are always up-to-date and easy to access.")

  st.image("/content/business-card-data-extraction.jpg")
  st.write("Get started with BizCardX and transform your physical business cards into an organized, searchable digital database today!")
